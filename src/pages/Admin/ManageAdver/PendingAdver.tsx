...
export const PendingAdver: React.FC = () => {
  ...
  return (
    <div className="relative flex w-full flex-col">
      <div className="">
        <h2 className="mb-4 text-2xl font-semibold">Các Quảng Cáo đang đợi</h2>
        ...
        {isLoading ? (
          ...
          <div>
            {advertisements.length === 0 ? (
              <p>Không có quảng cáo nào đang chờ xử lý.</p>
            ) : (
