  ...
  return (
    <AuroraBackground>
      <motion.div
        ...
        className="relative flex w-full max-w-[1000px] h-screen flex-col items-center justify-start gap-4 px-4 py-10"
      >
        <div className="w-full">
          ...
          <h2 className="mb-4 text-sm font-semibold"> Số lượng nội dung còn lại : {currentPakage?.limitContent} ký tự</h2>
          <h2 className="mb-4 text-sm font-semibold"> Số lượng ảnh còn lại : {currentPakage?.limitImage}</h2>
          <h2 className="mb-4 text-sm font-semibold"> Số lượng quảng cáo đã đăng : {currentPakage?.mornitoredQuantity} quảng cáo</h2>
